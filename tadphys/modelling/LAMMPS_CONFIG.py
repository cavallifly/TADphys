...
###################################################################
#PurelyRepulsiveLJepsilon = 0.2
PurelyRepulsiveLJepsilon = 1.0
#PurelyRepulsiveLJsigma   = 0.43679
PurelyRepulsiveLJsigma   = 1.0
PurelyRepulsiveLJcutoff  = 1.12246152962189*PurelyRepulsiveLJsigma

# mass http://lammps.sandia.gov/doc/mass.html
mass = "* %f" % (1.0/(PurelyRepulsiveLJsigma*PurelyRepulsiveLJsigma))
...
neighbor = "%f bin" % (0.3*PurelyRepulsiveLJsigma) # Standard choice for large (> 10,000 particles) systems
...
FENEK  = 30.0
#FENEK  = 300.0
FENER0 = 1.5*PurelyRepulsiveLJsigma
FENEepsilon = 1.0
#FENEepsilon = 10.0
FENEsigma   = 1.0*PurelyRepulsiveLJsigma
...
gamma=2.0/(PurelyRepulsiveLJsigma*PurelyRepulsiveLJsigma)
